...
define( 'BI_CURRENT_USER_ID', $current_user_id );
define( 'BI_CURRENT_USER_ROLE', $current_user_role );
...
function bi_init_global_acf_constants() {
	...
	define( 'BI_GOOGLE_CAPTCHA_KEY',        get_field( 'google_captcha_key', 'options') );
	define( 'BI_GOOGLE_CAPTCHA_SECRET',     get_field( 'google_captcha_secret', 'options') );
}

require_once THEME_DIR . '/includes/load.php';
require_once THEME_DIR . '/blocks/load.php';
require_once THEME_DIR . '/components/load.php';
